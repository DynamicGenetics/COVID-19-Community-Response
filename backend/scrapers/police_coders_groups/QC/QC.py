                    ...
                    if group["Title"] == ref["Title"]:
                        ...
                        if ref["Action"]:
                            ...
                            if ref["Action"] == "DELETE":
                                print(
                                    "Group {} deleted for reason {}".format(
                                        group["Title"], ref["notes"]
                                    )
                                )
                                ...
                                print(
                                    "Group {} changed for reason {}".format(
                                        group["Title"], ref["notes"]
                                    )
                                )
                                ...
                                groups_QCFiltered.append(group)
                                print(
                                    "WARNING: Group ACTION not recognised for group {}".format(
                                        group["Title"]
                                    )
                                )
