...
# ++++++++++++++++++++++++++++++++++
RAW_WELSH_LSOA = pd.read_csv("raw/lsoa_welsh_language_2011.csv", usecols=[2, 3])

RAW_WELSH_LA = pd.read_csv("raw/la_welsh_frequency_2018-19.csv", usecols=[1, 2, 3, 4])


# Read Population data (includes age based data)
RAW_POPULATION_LSOA = pd.read_excel(
...
RAW_OVER_65_LSOA = pd.read_excel(
    "raw/lsoa_population_2018-19.xlsx",
    sheet_name="Mid-2018 Persons",  # Sheet 4
...
RAW_POPULATION_LA = pd.read_csv("raw/la_population_age_2019.csv", usecols=[3, 15])
RAW_OVER_65_LA = pd.read_csv("raw/la_population_age_2019.csv", usecols=[3, 14])


# Read in IMD data
RAW_IMD_LSOA = pd.read_csv("raw/lsoa_IMD_2019.csv")

RAW_IMD_LA = pd.read_csv("raw/la_WIMD_2019.csv")

# Read in population density data
RAW_POPDENSITY_LSOA = pd.read_excel(
    "raw/lsoa_pop_density_2018-19.xlsx", sheet_name=3, usecols="A,B,E", skiprows=4
)

RAW_POPDENSITY_LA = pd.read_csv("raw/la_pop_density_2018.csv", usecols=[1, 11])
...
RAW_INTERNET_ACCESS_LA = pd.read_excel(
...
RAW_INTERNET_USE_LA = pd.read_excel(
    "raw/National Survey results - internet use and freqency of access by local authority.xlsx",
    usecols="A,B,C",
...
RAW_ETHNICITY_LA = pd.read_excel(
