                        ...
                        for dataField in properties.keys():
                            if dataField in src['layers'].keys(): 
                                ...
                                if layer['disabled'] == False:
                                    ...
                                    if layer['category'] not in layers.keys(): layers[layer['category']] = {}
                                        
                                    if dataField not in layers[layer['category']].keys():    
                                        layers[layer['category']][dataField]={
                                            'dataField' : dataField,
                                            'origin' : src['name'],
                                            'path' : src['path'],
                                        ...
                                        layers[layer['category']][dataField]['dataValues'].append(dataValue)
